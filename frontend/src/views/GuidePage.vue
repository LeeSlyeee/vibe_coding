...
.ai-feature h4 { margin: 0 0 8px 0; font-size: 18px; }
.ai-feature p { margin: 0; color: #555; line-height: 1.6; }
.icon-visual { font-size: 40px; }
...
@media (max-width: 768px) {
    ...
    .ai-feature { flex-direction: column; text-align: center; gap: 16px; }
}
</style>
