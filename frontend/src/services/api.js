...
export const diaryAPI = {
  ...
  updateDiary: async (id, data) => {
    ...
    // [Fix] Use Explicit Update Endpoint (POST) to resolve 405 Method Not Allowed
    // Backend (app.py) defines: @app.route('/api/diaries/<int:diary_id>/upt', methods=['POST'])
    const response = await api.post(`/diaries/${id}/upt`, mappedData);
    return response.data;
  },
