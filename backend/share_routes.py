...
def disconnect_user():
    ...
    # [SAFETY] Soft Delete implementation
    result = mongo.db.share_relationships.update_one({
        '$or': [
...
def get_shared_insights(target_id):
    ...
    try:
        ...
        print(f"⚠️ [Share] Sync Warning (Non-fatal): {e}")
