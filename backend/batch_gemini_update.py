...
if __name__ == "__main__":
    ...
    # Hardcoded Key Override (Temporary)
    manual_key = "AIzaSyAyHJM4BsRT46f2T-NQV5cktZF9f3_QfNw"
    print(f"🔑 Using Hardcoded API Key: {manual_key[:5]}...*****")
    Config.GEMINI_API_KEY = manual_key
