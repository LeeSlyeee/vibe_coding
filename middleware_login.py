...
class UserMeView(APIView):
    ...
    def get(self, request):
        ...
        return Response({
            ...
            # [Fix] Handle center relation safely
            'center_code': getattr(user.center, 'center_code', None) if getattr(user, 'center', None) else None
        })
    ...
    def post(self, request):
        ...
        if user is not None:
            ...
            return Response({
                ...
                'linked_center_code': getattr(user, 'center_code', None),
