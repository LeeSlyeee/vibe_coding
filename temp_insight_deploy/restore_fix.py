...
def run():
    ...
    print('Starting Deep Restoration for Jan 16-27...')
    ...
    for date_key, item in valid_data.items():
        try:
            ...
            # Find existing record (loose range)
            ...
            record.save()
            updated_count += 1
            print(f'Restored {date_key} (len={len(str(rich_data))})')
